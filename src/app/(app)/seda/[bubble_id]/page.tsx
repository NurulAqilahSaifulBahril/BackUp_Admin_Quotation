...
export default function SedaDetailPage() {
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <Section title="Agent User Information">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <EditableField
            fieldKey="agent"
            value={seda.agent}
          ...
          />
          <div>
            <div className="text-sm font-medium text-gray-500 mb-1">User Email / Code</div>
            <div className="text-gray-900">{seda.agent_user_email || seda.agent_code || "N/A"}</div>
            <p className="text-xs text-gray-400 mt-1">Resolved from user.bubble_id</p>
          </div>
        </div>
      </Section>
